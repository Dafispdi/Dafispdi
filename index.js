...
:   :  /   /:        
 :   :/___/  :        
  :       :   :        
   :_______:   :    DdosTools ${version}
           /   /    Owner: Dyzz
          /   /     Premium: true
          :  /      WhatsApp: 6288989562929
           :/       Telegram: @dyzznotsepuhh
                    Tools DDoS By Dyzz
========================================================================`)}
// [========================================] //
...
async function bootup() {
  try {
    ...
    console.log(`|| ▓▓░░░░░░░░ || 20%`);
    const getLatestVersion = await fetch('https://raw.githubusercontent.com/Greedbotz/attack/main/version5.1.7');
    const latestVersion = await getLatestVersion.text()
    console.log(`|| ▓▓▓░░░░░░░ || 30%`);
    if (version === latestVersion.trim()) {
    console.log(`|| ▓▓▓▓▓▓░░░░ || 60%`);
    
    const secretBangetJir = await fetch('https://raw.githubusercontent.com/Greedbotz/attack/main/pw.txt');
    const password = await secretBangetJir.text();
    await console.log(`Login Key Required`)
    permen.question('[\x1b[1m\x1b[31mDyzzDDOS Security\x1b[0m]: \n', async (skibidi) => {
      if (skibidi === password.trim()) {
        ...
        await sleep(700)
        console.clear()
        console.log(`Welcome To DyzzDDOS Tools ${version}`)
        await sleep(1000)
		    await banner()
...
Type exit To Stop
`);
permen.question('[\x1b[1m\x1b[31mDyzzDDOS Wifi Killer\x1b[0m]: \n', async (yakin) => {
if (yakin === 'exit') {
...
permen.question('[\x1b[1m\x1b[31mDyzzDDOS Chat AI\x1b[0m]: \n', async (yakin) => {
if (yakin === 'exit') {
...
const getNews = await fetch(`https://raw.githubusercontent.com/Greedbotz/attack/main/news.txt`)
const latestNews = await getNews.text();
const creatorCredits = `
Created And Coded Full By DyzzDDOS

Thx To:
ChatGPT ( Fixing Error )
Member And User ( Ga Buat Yang Dapet Gratis )
My Family
PLN Dan Telkomsel (Sumber Batrai dan Kuota)
Github
YouTube ( Music )
Allah SWT
`
permen.question('[\x1b[1m\x1b[32mDyzzDDOS Console\x1b[0m]: \n', (input) => {
...
| news         | show latest DyzzDDOS news
| ai           | Chat With Ai
...
${creatorCredits}`);
    ...
    console.log(`DyzzDDOS Ai Ragbot Started
